...
export type FavoritestSliceType = {
  favorites: Recipe[],
...
export const createFavoritesSlice: StateCreator<FavoritestSliceType & RecipesSliceType & NotificationSliceType, [], [], FavoritestSliceType> = (set, get, api) => ({
  favorites: [],
